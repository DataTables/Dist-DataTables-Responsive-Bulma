...
$jscomp.propertyToPolyfillSymbol[d],$jscomp.defineProperty(e,d,{configurable:!0,writable:!0,value:c})))};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(c,b){return $jscomp.findInternal(this,c,b).v}},"es6","es3");var _display=DataTable.Responsive.display,_original=_display.modal,_modal=$('<div class="modal DTED"><div class="modal-background"></div><div class="modal-content"><div class="modal-header"><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><div class="modal-body"/></div><button class="modal-close is-large" aria-label="close"></button></div>');
_display.modal=function(a){return function(c,b,e){b||(a&&a.header&&(b=_modal.find("div.modal-header"),b.find("button").detach(),b.empty().append('<h4 class="modal-title subtitle">'+a.header(c)+"</h4>")),_modal.find("div.modal-body").empty().append(e()),_modal.appendTo("body"),_modal.addClass("is-active is-clipped"),$(".modal-close").one("click",function(){_modal.removeClass("is-active is-clipped")}),$(".modal-background").one("click",function(){_modal.removeClass("is-active is-clipped")}))}};
